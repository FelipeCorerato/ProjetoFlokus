    ...
    <form id="form1" runat="server">
        <div>
            ...
            *Nome:<br />
            ...
            <br />
                *CPF:<br />
            <asp:TextBox ID="txtCPF" runat="server" Width="245px" MaxLength="10"></asp:TextBox>
            ...
            *Confirmar Senha<br />
            ...
            <br />
            <asp:Button ID="btnInserir" runat="server" OnClick="btnInserir_Click" Text="Inserir" /></div>
    </form>
</body>
</html>
